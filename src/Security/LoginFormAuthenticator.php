...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey)
    {
        ...
        switch ($token->getRoleNames()) {
            case  in_array('ROLE_ADMIN',$token->getRoleNames()):
                return new RedirectResponse($this->urlGenerator->generate('app_admin_index'));
            case in_array('ROLE_MODERATOR',$token->getRoleNames()):
                return new RedirectResponse($this->urlGenerator->generate('app_moderator_index'));
            default:
